...
import { TEST_TYPES, useCreateNewTestForm } from "./hooks/use-create-new-test-form";
...
export default function CreateNewTest({ onNext, onBack }: Props) {
  ...
  return (
    <div className="w-full px-2 sm:px-6 md:px-8 lg:px-16 py-8">
      {/* Judul halaman */}
      <h2 className="font-bold text-2xl mb-1">Create New Test</h2>
      ...
      {/* Nama Tes */}
      <div className="mb-4">
        <label className="block text-sm mb-1 font-medium">Test Name</label>
